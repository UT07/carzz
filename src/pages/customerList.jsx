...
function CustomerList(props){
    ...
    const init=()=>{
        ...
        Axios.post("https://carz3330.netlify.app/customerSearch").then((res)=>{
    ...
    return(
        <div>
           ...
           <Input  addonAfter={selectAfter} onPressEnter={(val)=>{
               if(filter==="CustID"){
                   Axios.post("https://carz3330.netlify.app/filterCustomerSearchID",{CustID:val.target.value}).then((res)=>{
                   console.log(res.data) 
                   setCustomerList(res.data);
                   });
               }
               ...
               if(filter==="Name"){
                Axios.post("https://carz3330.netlify.app/nameSearch",{Name:val.target.value}).then((res)=>{
                    console.log(res.data)
                    setCustomerList(res.data)
                });
               }
